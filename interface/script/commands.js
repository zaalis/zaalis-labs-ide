...
SLASH_HANDLERS.doctor = async (arg, out, lang) => {
    ...
    html += line(!!data.installer, lang === 'en' ? 'Installer' : 'Installateur', data.installer ? (data.installerPath || 'native/installer/zaalis-linux-x64.deb') : (lang === 'en' ? 'missing' : 'absent'), !data.installer);
