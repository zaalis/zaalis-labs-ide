...
window.HELP_TOPICS = [
  ...
  {
    q: "C'est quoi Metal et CPU (accélération GPU) ?",
    a: "Ce sont les deux façons dont le moteur GGUF peut calculer sur macOS. Metal utilise le GPU Apple pour accélérer les réponses. CPU calcule uniquement avec le processeur, ce qui marche partout mais reste plus lent. Auto choisit Metal sur macOS, puis repasse en CPU si le moteur Metal ne démarre pas."
  },
  {
